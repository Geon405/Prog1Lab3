...
public class Question4 {
	...
	System.out.println("Press 1 to convert CAD to EUR");
	...
	System.out.println("Write the value of meters you want to convert > ");
	double meters = scan.nextDouble();
	double metersToFt = meters = 3.28;
	System.out.println (meters + " meter is equal to " + metersToFt + " Ft");
	...
	System.out.print("Write the amount of Celsius you want convert in Fahrenheit");
	...
	System.out.print("Write the value of Fahrenheit you want convert into Celsius");
	...
	System.out.print("Write the amount of Canadian dollars you want to convert to Euro");
	canadianDollars = scan.nextDouble();
	double canadianToEur = canadianDollars = 0.68;
	System.out.println(currency.format(canadianDollars) + " CAD is equal to "
